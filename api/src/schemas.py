...
class BidderPolicySchema(_CamelModel):
    ...
    budget_share_by_role: Optional[dict[str, float]] = None
    phase_bias: Optional[str] = None
    prefer_young_players: bool = False
    max_age_preference: Optional[int] = None
    prefer_high_start_probability: bool = False
    min_start_probability: Optional[float] = Field(default=None, ge=0.0, le=1.0)
    prefer_high_variance: bool = False
    prefer_multi_role: bool = False
    min_num_roles: Optional[int] = Field(default=None, ge=1)
    budget_share_by_block: Optional[dict[str, float]] = None
    max_top_tier_count: Optional[int] = Field(default=None, ge=0)
    target_top_tier_count: Optional[int] = Field(default=None, ge=0)
    avoid_top_tier_early: bool = False
    adaptive: bool = False
    adapt_on: Optional[list[str]] = None
